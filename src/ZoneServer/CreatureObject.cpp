...
void CreatureObject::updateMovementProperties()
{
    ...
    case CreaturePosture_Upright:
    {
        if (GetBuffExists(jedi_force_run_1))
        {
            ...
            mCurrentTerrainNegotiation	= mBaseTerrainNegotiation; //33.0f;
        }
        else if (GetBuffExists(jedi_force_run_2))
        {
            ...
            mCurrentAcceleration		= 0.95f;
            mCurrentTurnRate			= mBaseTurnRate;
            mCurrentTerrainNegotiation	= mBaseTerrainNegotiation; //66.0f;
        }
        else if (GetBuffExists(jedi_force_run_3))
        {
            ...
            mCurrentAcceleration		= 0.95f;
            mCurrentTurnRate			= mBaseTurnRate;
            mCurrentTerrainNegotiation	= mBaseTerrainNegotiation; //99.0f;
        }
        else
        {
